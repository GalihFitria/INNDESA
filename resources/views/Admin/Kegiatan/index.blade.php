        ...
        <table class="w-full border-collapse border border-gray-300">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="border border-gray-300 p-3 text-left text-xs font-medium text-gray-500 uppercase">Foto</th>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="border border-gray-300 p-3 text-sm text-gray-900">KT001</td>
                    <td class="border border-gray-300 p-3 text-sm text-gray-900">Kelompok Wanita Tani(KWT)</td>
                    <td class="border border-gray-300 p-3 text-sm text-gray-900">Kelompok Wanita Tani(KWT)</td>
                    <td class="border border-gray-300 p-3 text-sm text-gray-900">Kelompok Wanita Tani(KWT)</td>
                    <td class="border border-gray-300 p-3 text-sm text-gray-900">Kelompok Wanita Tani(KWT)</td>
                    <td class="border border-gray-300 p-3 text-sm text-gray-900">Kelompok Wanita Tani(KWT)</td>
                    <td class="border border-gray-300 p-3 text-sm text-gray-900">Serayu News</td>
