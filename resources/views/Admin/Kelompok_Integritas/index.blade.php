...
@section('title', 'INNDESA - Kelola Kelompok Integrasi')
        ...
        <table class="w-full border-collapse border border-gray-300" id="dataTable">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="border border-gray-300 p-3 text-center text-xs font-medium text-gray-500 uppercase">Id Kategori</th>
                    <th class="border border-gray-300 p-3 text-center text-xs font-medium text-gray-500 uppercase">Nama Kelompok Integritas</th>
