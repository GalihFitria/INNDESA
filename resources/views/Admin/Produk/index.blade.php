...
@section('title', 'Kelola Produk - INNDESA')
        ...
        <table class="w-full border-collapse border border-gray-300">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="border border-gray-300 p-3 text-left text-xs font-medium text-gray-500 uppercase">Id Produk</th>
                    <th class="border border-gray-300 p-3 text-left text-xs font-medium text-gray-500 uppercase">Nama Kelompok</th>
                    <th class="border border-gray-300 p-3 text-left text-xs font-medium text-gray-500 uppercase">Nama Produk</th>
                    <th class="border border-gray-300 p-3 text-left text-xs font-medium text-gray-500 uppercase">Foto Produk</th>
                    <th class="border border-gray-300 p-3 text-left text-xs font-medium text-gray-500 uppercase">Harga</th>
                    <th class="border border-gray-300 p-3 text-left text-xs font-medium text-gray-500 uppercase">Stok</th>
                    <th class="border border-gray-300 p-3 text-left text-xs font-medium text-gray-500 uppercase">Deskripsi</th>
                    <th class="border border-gray-300 p-3 text-left text-xs font-medium text-gray-500 uppercase">Sertifikat</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    ...
                    <td class="border border-gray-300 p-3">
                        <img src="https://via.placeholder.com/64" alt="Beras Organik Premium" class="w-16 h-16 object-cover rounded border border-gray-300">
                    </td>
                    <td class="border border-gray-300 p-3 text-sm text-gray-500">Rp 25.000/kg</td>
                    <td class="border border-gray-300 p-3 text-sm text-gray-500">100</td>
                    <td class="border border-gray-300 p-3 text-sm text-gray-500">Beras organik berkualitas tinggi</td>
                    <td class="border border-gray-300 p-3 text-sm text-gray-500">Sertifikat Organik</td>
                </tr>
            </tbody>
        </table>
    </div>
