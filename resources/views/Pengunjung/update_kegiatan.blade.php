            ...
            <div class="w-full lg:w-2/3 px-2 lg:px-4">
                <div class="mb-4 sm:mb-6">
                 ...
                 1.5 0 0 1 1.5-1.5z" />
                    ...
                    <!-- TAMBAHKAN BAGIAN INI UNTUK MENAMPILKAN TANGGAL UPDATE -->
                    ...
                    <p class="text-gray-500 mb-4 flex items-center gap-2 text-sm sm:text-base">
                        ...
                        Updated: {{ \Carbon\Carbon::parse($kegiatan->updated_at)->locale('id')->translatedFormat('l, d F Y') }}
                    </p>
                    @endif
                    ...
                    <div id="kegiatan-container" class="space-y-4 sm:space-y-5 mb-6">
                        ...
                        <div class="kegiatan-item kegiatan-item-mobile flex items-start mb-4 pb-4 border-b border-gray-100 last:border-b-0">
                            ...
                            <div class="kegiatan-content-mobile flex-1">
                                ...
                                <!-- TAMBAHKAN BAGIAN INI UNTUK MENAMPILKAN TANGGAL UPDATE DI KEGIATAN LAINNYA -->
                                @if($item->updated_at)
                                <p class="text-xs text-gray-400 mb-2">
                                    <i class="fas fa-sync-alt mr-1"></i>
                                    Diperbarui: {{ \Carbon\Carbon::parse($item->updated_at)->locale('id')->translatedFormat('d F Y') }}
                                </p>
                                @endif
